...
from src.routing_algorithms.fully_echoed_q_routing import FullyEchoedQLearningRouting
from src.routing_algorithms.distance_based_q_learning_routing import DistanceBasedQLearningRouting
from src.routing_algorithms.ucb_q_learning_routing import UCBQLearningRouting
from src.routing_algorithms.none_routing import NoneRouting
...
class RoutingAlgorithm(Enum):
    ...
    RND = RandomRouting
    QL = QLearningRouting
    DBQL = DistanceBasedQLearningRouting
    FEQR = FullyEchoedQLearningRouting
    UCBQL = UCBQLearningRouting
    NONE = NoneRouting
...
ROUTING_ALGORITHM = RoutingAlgorithm.FEQR
